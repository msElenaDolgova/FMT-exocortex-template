...
> **Развитие ≠ Образование.** Платформа IWE — про развитие (себя, команды, сообщества), НЕ про образование. Не использовать: «школа», «вуз», «студент», «преподаватель», «обучение», «учёба». Замены: студент → участник/пользователь, преподаватель → наставник, обучение → развитие/практика.
