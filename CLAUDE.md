...
Рабочая директория: `/Users/elenadolgova/IWE/` (не из sub-директорий). `/Users/elenadolgova/IWE/memory/` = симлинк на auto-memory.
...
<<<<<<< /var/folders/8s/_xxym44x3kd4rlrzy_pgvpwh0000gn/T/tmp.V1VfLywlUb/claude-merge.md
- `/Users/elenadolgova/IWE/` — рабочая директория
=======
- `DS-strategy` (не `DS-strategy`) — личный governance-хаб
- `{{HOME_DIR}}/IWE/` — рабочая директория
>>>>>>> /var/folders/8s/_xxym44x3kd4rlrzy_pgvpwh0000gn/T/tmp.V1VfLywlUb/files/CLAUDE.md
