...
Каждый репозиторий в `/Users/elenadolgova/IWE/` содержит `WORKPLAN.md` в корне с текущими РП.

**Агрегация:** При создании плана дня/недели Стратег:
1. Обходит все `/Users/elenadolgova/IWE/*/WORKPLAN.md`
...
for repo in $(ls /Users/elenadolgova/IWE/); do
  if [ -d /Users/elenadolgova/IWE/$repo/.git ]; then
    echo "=== $repo ===" && cd /Users/elenadolgova/IWE/$repo && git log --oneline --since="1 week ago" 2>/dev/null
  fi
done
```
...
> **Полное описание:** `/Users/elenadolgova/IWE/CLAUDE.md` секция 2.
