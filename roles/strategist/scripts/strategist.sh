...
notify_telegram() {
    local scenario="$1"
    "/Users/elenadolgova/IWE/DS-exocortex/roles/synchronizer/scripts/notify.sh" strategist "$scenario" >> "$LOG_FILE" 2>&1 || true
}
...
case "$1" in
    ...
    "week-review")
        ...
        KI_REPO="/Users/elenadolgova/IWE/DS-Knowledge-Index-msElenaDolgova"
